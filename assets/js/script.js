...
const TRANSLATIONS = {
    fr: {
        ...
        'about.p4': `Ce qui me distingue ? Une combinaison rare de compétences : du <strong>C embarqué</strong> (Arduino, bas niveau) au <strong>React/TypeScript</strong> (web moderne), en passant par l'<strong>IA et les algorithmes</strong> (Minimax, Alpha-Beta). Peu d'étudiants en 3ème année couvrent un spectre aussi large — du hardware au full stack.`,
        ...
        'projects.staffbar-desc': `Plateforme de recrutement spécialisée dans l'hôtellerie et la restauration avec messagerie en temps réel via Supabase, filtres avancés et gestion de profils.`,
        ...
        'projects.marketplace-title': `Merch Exchange — Marketplace Musicale`,
        'projects.marketplace-desc': `Marketplace dédiée aux articles de musique avec publication d'annonces, interface d'administration Django dynamique et gestion complète des utilisateurs.`,
        'projects.marketplace-h1': `✓ CRUD annonces`,
        'projects.marketplace-h2': `✓ Admin interface`,
        'projects.marketplace-h3': `✓ Gestion utilisateurs`,
        'projects.trustlink-title': `TrustLink — Marketplace Cross-Border`,
        'projects.trustlink-desc': `Plateforme de marketplace <strong>cross-border</strong> avec système d'escrow, 3 applications interconnectées, KYC, gestion des litiges, paiements vidéo et 22 tables en base de données.`,
        'projects.trustlink-h1': `✓ 3 apps interconnectées`,
        'projects.trustlink-h2': `✓ Système d'escrow & KYC`,
        'projects.trustlink-h3': `✓ 22 tables BDD`,
        'projects.trustlink-h4': `✓ Gestion des litiges`,
        'projects.trustlink-role': `Full Stack Developer`,
        'projects.trustlink-badge': `🏆 Projet phare`,
        'projects.ctg-title': `Coding Tech Games — Jeu Multijoueur`,
        'projects.ctg-desc': `Jeu multijoueur compétitif avec plateaux interactifs et défis algorithmiques en temps réel. Codez pour progresser et affrontez d'autres joueurs grâce à l'exécution de code via Piston API.`,
        'projects.ctg-h1': `✓ Multijoueur temps réel`,
        'projects.ctg-h2': `✓ Exécution code Piston API`,
        'projects.ctg-h3': `✓ Plateaux interactifs`,
        'projects.ctg-role': `Full Stack Developer`,
    ...
    en: {
        ...
        'about.p4': `What sets me apart? A rare combination of skills: from <strong>embedded C</strong> (Arduino, low-level) to <strong>React/TypeScript</strong> (modern web), through <strong>AI and algorithms</strong> (Minimax, Alpha-Beta). Few third-year students cover such a broad spectrum — from hardware to full stack.`,
        ...
        'projects.staffbar-title': `StaffBar`,
        'projects.staffbar-desc': `Recruitment platform specialized in hospitality and restaurants with real-time messaging via Supabase, advanced filters and profile management.`,
        ...
        'projects.marketplace-title': `Merch Exchange — Music Marketplace`,
        'projects.marketplace-desc': `Music-themed marketplace with ad listing, dynamic Django admin interface and complete user management.`,
        'projects.marketplace-h1': `✓ Ad CRUD`,
        'projects.marketplace-h2': `✓ Admin interface`,
        'projects.marketplace-h3': `✓ User management`,
        'projects.trustlink-title': `TrustLink — Cross-Border Marketplace`,
        'projects.trustlink-desc': `<strong>Cross-border</strong> marketplace platform with escrow system, 3 interconnected apps, KYC, dispute management, video payments and 22 database tables.`,
        'projects.trustlink-h1': `✓ 3 interconnected apps`,
        'projects.trustlink-h2': `✓ Escrow system & KYC`,
        'projects.trustlink-h3': `✓ 22 DB tables`,
        'projects.trustlink-h4': `✓ Dispute management`,
        'projects.trustlink-role': `Full Stack Developer`,
        'projects.trustlink-badge': `🏆 Featured Project`,
        'projects.ctg-title': `Coding Tech Games — Multiplayer Game`,
        'projects.ctg-desc': `Competitive multiplayer game with interactive boards and real-time algorithmic challenges. Code to progress and compete against other players with live code execution via Piston API.`,
        'projects.ctg-h1': `✓ Real-time multiplayer`,
        'projects.ctg-h2': `✓ Code execution Piston API`,
        'projects.ctg-h3': `✓ Interactive boards`,
        'projects.ctg-role': `Full Stack Developer`,
        'projects.gomoku-title': `Gomoku AI`,
